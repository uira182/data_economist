...
### Exemplo 1: importar os módulos (IBGE, BCB SGS, ComexStat, EIA)
...
# EIA: dados energéticos — requer TOKEN_EIA no .env
dados = data_economist.eia.get_steo("PATC_WORLD", "monthly")
